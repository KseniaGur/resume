...
\begin{itemize}
  \item Разработала пайплайн сопоставления товаров (product matching) с использованием ML-подходов.
  \item Настроила поисковую систему для текстовых данных.
  \item Участвовала в разработке REST API-сервиса (FastAPI, Docker); отвечала за логирование.
  \item Реализовывала взаимодействие с базами данных: PostgreSQL, MongoDB, Redis.
\end{itemize}
